...
<head>
    <meta charset="UTF-8">
    <title>Veículos – GW Fretes</title>
...
<div class="container">
    ...
    <div class="page-header">
        <h1>Veículos</h1>
        <a href="${pageContext.request.contextPath}/veiculos?acao=novo" class="btn btn-primary">
            + Novo Veículo
        </a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/veiculos?acao=excluir&id=${v.id}"
                                           ...
                                           onclick="return confirm('Excluir veículo ${v.placa}?')">
                                            Excluir
                                        </a>
                                    </td>
                                </tr>
