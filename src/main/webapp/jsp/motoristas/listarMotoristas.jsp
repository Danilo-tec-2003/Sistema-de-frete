...
<head>
    <meta charset="UTF-8">
    <title>Motoristas – GW Fretes</title>
...
<div class="container">
    ...
    <div class="page-header">
        <h1>Motoristas</h1>
        <a href="${pageContext.request.contextPath}/motoristas?acao=novo" class="btn btn-primary">
            + Novo Motorista
        </a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/motoristas?acao=excluir&id=${m.id}"
                                           ...
                                           onclick="return confirm('Excluir motorista ${m.nome}?')">
                                            Excluir
                                        </a>
                                    </td>
                                </tr>
